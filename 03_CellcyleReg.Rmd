...
wt1Filtered<-readRDS("./WT1_filtered.rds")
...
```{R}
# Run PCA
wt1Filtered <- RunPCA(object = wt1Filtered)
...
```{R}
VizDimLoadings(wt1Filtered, dims = 1:2, reduction = "pca")
...
pct <- wt1Filtered[["pca"]]@stdev / sum(wt1Filtered[["pca"]]@stdev) * 100
...
wt1Filtered <- FindNeighbors(wt1Filtered, dims = 1:40)
#wt1Filtered <- FindClusters(wt1Filtered, resolution = 0.5)
...
DimPlot(wt1Filtered,reduction="umap")   
#DimPlot(wt1Filtered,reduction="umap",group.by="SCT_snn_res.0.5")   
